...
@section('title', __('user::dashboard.users.update.form.wallets_transactions'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{ __('user::dashboard.users.update.form.wallets_transactions') }}</a>
                </li>
            </ul>
        </div>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                {{__('user::dashboard.users.datatable.clients')}}
                                                            </label>
                                                            <select name="user_id"
                                                                    id="single"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('catalog::dashboard.brands.datatable.description')}}</th>
                                    <th>{{__('order::dashboard.orders.show.order_id')}}</th>
...
<script>
    let walletId = '';
    @if(request()->wallet)
        walletId = "?wallet={{round(request()->wallet / 34567)}}"
    @endif
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : `{{ url(route('dashboard.wallets.transactions_datatable')) }}${walletId}`,
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columnDefs: [
              {
                  ...
                  render: function(data, type, full, meta) {
                      // Show
                      var showUrl = '{{ route("dashboard.wallets.transactions.show", ":id") }}';
