...
//            $user->notify((new WelcomeNotification($request->email, $request->password)));
    ...
    {
        $user->update([
            "code_verified" => $user->mobile == '99999999' ? '1111' : generateRandomOTPCode(4),
            "verification_expire_at" => Carbon::now()->addMinutes(2)->toDateTimeString(),
        ]);

        if($user->mobile != '99999999'){
    ...
    public function sendSms($user)
    {
        ...
        $result = \Message::send([
            ...
            'body'  => 'Your Verification Code is : '. $user->code_verified,
        ]);
