...
return [
    ...
    'products' => [
        ...
        'form' => [
            ...
            'codes' => 'اكواد السيريال',
            'codes_notes'   => 'يجب عليك إدخال كود واحد في كل سطر',
            'price_in_country'  => 'السعر في :country',
            'prices'    => 'الاسعار',
            'type'  => 'نوع المنتج',
            ...
            'tabs' => [
                'export' => 'نسخ المنتجات',
                'qty_codes'  => 'الكمية واكواد السيريال',
                'offers' => 'سعر المنتج',
                'categories' => 'اقسام المنتج',
                'gallery' => 'معرض الصور',
                'general' => 'بيانات عامة',
                'servers'   => 'سيرفرات الشحن',
            ...
            'available_servers' => 'سيرفرات الشحن المتاحة',
            'title' => 'عنوان',
            'vendors' => 'متجر المنتج',
            'add_ons' => [
                'name' => 'الاسم',
    ...
    'servers' => [
        ...
        'routes' => [
            'clone' => 'نسخ و اضافة سيرفر جديد',
            'create' => 'اضافة السيرفرات',
            'index' => 'السيرفرات',
            'update' => 'تعديل السيرفر',
            'show' => 'تفاصيل السيرفر',
        ],
        'validation' => [
            'select_option_values' => 'من فضلك اختر قيم لإختيارات المنتج',
