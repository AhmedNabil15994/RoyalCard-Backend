            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::dashboard.products.form.image')}}</th>
                                    <th>{{__('catalog::dashboard.products.form.title')}}</th>
                                    <th>{{__('catalog::dashboard.products.form.type')}}</th>
                                    <th>{{__('catalog::dashboard.products.form.sku')}}</th>
                                    <th>{{__('catalog::dashboard.products.form.qty')}}</th>
                                    <th>{{__('catalog::dashboard.products.datatable.categories')}}</th>
                                    <th>{{__('catalog::dashboard.products.form.prices')}}</th>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.products.deletes')) }}')">
