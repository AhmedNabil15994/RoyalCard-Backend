                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('order::dashboard.orders.show.order_id')); ?></th>
...
<script>
    let walletId = '';
    <?php if(request()->wallet): ?>
        walletId = "?wallet=<?php echo e(round(request()->wallet / 34567)); ?>"
    <?php endif; ?>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : `<?php echo e(url(route('dashboard.wallets.transactions_datatable'))); ?>${walletId}`,
              type  : "GET",
              data  : {
                  req : data,
              },
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/User/Resources/views/dashboard/users/wallets/transactions.blade.php ENDPATH**/ ?>