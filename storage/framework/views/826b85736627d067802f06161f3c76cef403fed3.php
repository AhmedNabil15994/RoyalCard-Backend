<div class="tab-pane fade in" id="cashback">
            ...
            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(in_array($country->id,setting('supported_countries'))): ?>
                    <li class=" <?php echo e($country->id == setting('default_country') ? 'active' : ''); ?>">
                        <a href="#colored-rounded-tab-cashback-<?php echo e($country->id); ?>" data-toggle="tab" aria-expanded="false"> <?php echo e($country->title); ?>
    ...
    <div class="tab-content">
        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(in_array($country->id,setting('supported_countries'))): ?>
                <div class="countryOffer tab-pane <?php if($country->id == setting('default_country')): ?> active <?php endif; ?>" id="colored-rounded-tab-cashback-<?php echo e($country->id); ?>">
...
<?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Catalog/Resources/views/dashboard/products/components/cashback.blade.php ENDPATH**/ ?>