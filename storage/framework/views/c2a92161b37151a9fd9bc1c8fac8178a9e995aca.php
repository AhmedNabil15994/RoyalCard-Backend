...
<script>
    function tableGenerate(data = '') {
        ...
        var dataTable =
            $('#dataTable').DataTable({
                ajax: {
                    url: "<?php echo e(url(route('dashboard.orders.datatable'))); ?>?order_status_id=3&item_code="+'<?php echo e(request()->get('item_code')); ?>',
                    type: "GET",
                    data: {
                        req: data,
                    },
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Order/Resources/views/dashboard/pending_orders/index.blade.php ENDPATH**/ ?>