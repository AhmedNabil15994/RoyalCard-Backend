<?php $__env->startSection('title', __('slider::dashboard.sliders.routes.index')); ?>
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#"><?php echo e(__('slider::dashboard.sliders.routes.index')); ?></a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_sliders')): ?>
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="<?php echo e(url(route('dashboard.sliders.create'))); ?>"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th><?php echo e(__('slider::dashboard.sliders.datatable.image')); ?></th>
                                    <th><?php echo e(__('slider::dashboard.sliders.datatable.title')); ?></th>
                                    <th><?php echo e(__('slider::dashboard.sliders.datatable.status')); ?></th>
                                    <th><?php echo e(__('slider::dashboard.sliders.datatable.created_at')); ?></th>
                                    <th><?php echo e(__('slider::dashboard.sliders.datatable.options')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('<?php echo e(url(route('dashboard.sliders.deletes'))); ?>')">
    ...
    function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "<?php echo e(url(route('dashboard.sliders.datatable'))); ?>",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority:1,
                            width: '13%',
                            title: '<?php echo e(__('slider::dashboard.sliders.datatable.options')); ?>',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '<?php echo e(route("dashboard.sliders.edit", ":id")); ?>';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '<?php echo e(route("dashboard.sliders.destroy", ":id")); ?>';
                                deleteUrl = deleteUrl.replace(':id', data);

                                return `
                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_sliders')): ?>
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Slider/Resources/views/dashboard/sliders/index.blade.php ENDPATH**/ ?>