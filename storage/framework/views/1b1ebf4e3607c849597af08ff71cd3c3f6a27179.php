...
<script>
    function tableGenerate(data = '') {
        ...
        var dataTable =
            $('#dataTable').DataTable({
                ajax: {
                    url: "<?php echo e(url(route('dashboard.orders.datatable'))); ?>?order_status_id=5&country_id="+'<?php echo e(request()->get('country_id')); ?>',
                    type: "GET",
                    data: {
                        req: data,
                    },
...
responsivePriority:1,
    ...
    jQuery(document).ready(function() {
      let trainer_id = "<?php echo e(request('trainer_id')); ?>";
      if(trainer_id != ''){
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Order/Resources/views/dashboard/incomplete_orders/index.blade.php ENDPATH**/ ?>