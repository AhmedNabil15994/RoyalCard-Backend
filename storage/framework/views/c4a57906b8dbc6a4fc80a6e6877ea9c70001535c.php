<?php $__env->startSection('title', __('slider::dashboard.sliders.routes.create')); ?>
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#"><?php echo e(__('slider::dashboard.sliders.routes.create')); ?></a>
                    </li>
                </ul>
            </div>
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Slider/Resources/views/dashboard/sliders/create.blade.php ENDPATH**/ ?>