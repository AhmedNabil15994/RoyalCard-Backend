<?php $__env->startSection('title', __('user::dashboard.users.index.title')); ?>
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#"><?php echo e(__('user::dashboard.users.index.title')); ?></a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="<?php echo e(url(route('dashboard.users.create'))); ?>"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.image')); ?></th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.name')); ?></th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.email')); ?></th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.mobile')); ?></th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.created_at')); ?></th>
                                    <th><?php echo e(__('user::dashboard.users.datatable.options')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('<?php echo e(url(route('dashboard.users.deletes'))); ?>')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "<?php echo e(url(route('dashboard.users.datatable'))); ?>",
              type  : "GET",
              data  : {
                  req : data,
              },
...
responsivePriority: 1,              width: '13%',
              ...
              render: function(data, type, full, meta) {
                        ...
                        // Edit
      					var editUrl = '<?php echo e(route("dashboard.users.edit", ":id")); ?>';
      					editUrl = editUrl.replace(':id', data);

                        // Show
                        var showUrl = '<?php echo e(route("dashboard.users.show", ":id")); ?>';
                        showUrl = showUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '<?php echo e(route("dashboard.users.destroy", ":id")); ?>';
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/User/Resources/views/dashboard/users/index.blade.php ENDPATH**/ ?>