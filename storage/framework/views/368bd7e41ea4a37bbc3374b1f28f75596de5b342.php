...
<script>
    function tableGenerate(data = '') {
        ...
        var dataTable =
            $('#dataTable').DataTable({
                ajax: {
                    url: "<?php echo e(url(route('dashboard.orders.datatable'))); ?>?order_status_id=1&country_id="+'<?php echo e(request()->get('country_id')); ?>',
                    type: "GET",
                    data: {
                        req: data,
                    },
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Order/Resources/views/dashboard/active_orders/index.blade.php ENDPATH**/ ?>