<?php $__env->startSection('title', __('category::dashboard.categories.routes.index')); ?>
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#"><?php echo e(__('category::dashboard.categories.routes.index')); ?></a>
                    </li>
                </ul>
            </div>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_categories')): ?>
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="<?php echo e(url(route('dashboard.categories.create'))); ?>"
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.image')); ?></th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.title')); ?></th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.type')); ?></th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.status')); ?></th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.created_at')); ?></th>
                                    <th><?php echo e(__('category::dashboard.categories.datatable.options')); ?></th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('<?php echo e(url(route('dashboard.categories.deletes'))); ?>')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "<?php echo e(url(route('dashboard.categories.datatable'))); ?>",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '<?php echo e(__('category::dashboard.categories.datatable.options')); ?>',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '<?php echo e(route("dashboard.categories.edit", ":id")); ?>';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '<?php echo e(route("dashboard.categories.destroy", ":id")); ?>';
                                deleteUrl = deleteUrl.replace(':id', data);
                                var deleteBtn  = full.category_id ===  null ? `` : ` <a href="javascript:;" onclick="deleteRow('` + deleteUrl + `')" class="btn btn-sm red">
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Category/Resources/views/dashboard/categories/index.blade.php ENDPATH**/ ?>