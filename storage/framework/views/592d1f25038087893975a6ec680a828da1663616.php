<?php $__env->startSection('title', __('area::dashboard.countries.routes.index')); ?>
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#"><?php echo e(__('area::dashboard.countries.routes.index')); ?></a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_countries')): ?>
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="<?php echo e(url(route('dashboard.countries.create'))); ?>" class="btn sbold green">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                <?php echo e(__('area::dashboard.countries.routes.index')); ?>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th><?php echo e(__('area::dashboard.countries.datatable.title')); ?></th>
                                    <th><?php echo e(__('area::dashboard.countries.datatable.status')); ?></th>
                                    <th><?php echo e(__('area::dashboard.countries.datatable.created_at')); ?></th>
                                    <th><?php echo e(__('area::dashboard.countries.datatable.options')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('<?php echo e(url(route('dashboard.countries.deletes'))); ?>')">
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "<?php echo e(url(route('dashboard.countries.datatable'))); ?>",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columnDefs: [
      			...
      			},
            {
              targets: -1,
              width: '13%',
              title: '<?php echo e(__('area::dashboard.countries.datatable.options')); ?>',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '<?php echo e(route("dashboard.countries.edit", ":id")); ?>';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '<?php echo e(route("dashboard.countries.destroy", ":id")); ?>';
      					deleteUrl = deleteUrl.replace(':id', data);

      					return `
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_countries')): ?>
      						<a href="`+editUrl+`" class="btn btn-sm blue" title="Edit">
      			              <i class="fa fa-edit"></i>
      			            </a>
      					<?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_countries')): ?>
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/Area/Resources/views/dashboard/countries/index.blade.php ENDPATH**/ ?>