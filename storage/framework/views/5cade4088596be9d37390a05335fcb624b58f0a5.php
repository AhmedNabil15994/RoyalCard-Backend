<?php $__env->startSection('title', __('user::dashboard.admins.create.title')); ?>
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#"><?php echo e(__('user::dashboard.admins.create.title')); ?></a>
                </li>
            </ul>
        </div>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting"
                                                    data-toggle="tab">
                                                    <?php echo e(__('user::dashboard.admins.create.form.general')); ?>
...
<?php echo $__env->make('apps::dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmed-nabil94/Desktop/PhpstormProjects/RoyalCard-Backend/Modules/User/Resources/views/dashboard/admins/create.blade.php ENDPATH**/ ?>